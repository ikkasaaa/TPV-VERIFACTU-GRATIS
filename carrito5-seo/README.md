...
mes, `blog_AAAA_MM.py`, más una segunda capa de sector `blog_AAAA_MMb.py` y una
tercera de pregunta y respuesta `blog_preguntas_*.py`, de septiembre de 2026 a
junio de 2027: 69 posts con su fecha de publicación. El
